...
Our best model had the following coefficients shown in the summary Table 3.3.2, from which we found that the variable FluVac that indicated whether the participant had a flu shot for the past 12 months. The p-value = 0.155 was not significant enough, so we did not have a conclusion on whether the variable was associated with the response.
...
Similarly, from summary Table 3.3.2 above we found that the variable DirectContactYes that showed whether the participant had directed contact with people or not also had an unpromising p-value=0.053. We removed the FluVac variable first and compared the models using the deviance. From the following summary Table 3.3.4 one can see that the p-value of the Chi-squared statistic was 0.085, suggesting again that we did not have a conclusion whether or not there was an association between the COVID status and having direct contact with people.
