...
```
To test the homogeneity for COVID-19 death probability condition on years, we can use the Chi-square test and the null hypothesis of homogeneity corresponding to:
$H_0:P_{j|i}=P_{·j} $
...
```
From Table 3.1.2, we can see that the odds ratio for all three years are not equal to 1, which indicated that there exists association between year and COVID-19 death proportion  
